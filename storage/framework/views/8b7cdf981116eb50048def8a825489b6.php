            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="tn-right">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="bk-btn" style="background: transparent; color: #19191a; border: 1px solid #dfa974; margin-right: 5px;">Đăng nhập</a>
...
<!-- Header End -->
<?php /**PATH D:\xampp\htdocs\CODEPHP\resources\views/layouts/header.blade.php ENDPATH**/ ?>