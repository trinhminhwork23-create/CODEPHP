...
unset($__errorArgs, $__bag); ?>" name="name" placeholder="Nhập tên phòng" value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="room_code" placeholder="VD: PH001" value="<?php echo e(old('room_code')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="price" placeholder="0" step="1000" value="<?php echo e(old('price')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="capacity" placeholder="2" value="<?php echo e(old('capacity')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="size" placeholder="35" value="<?php echo e(old('size')); ?>">
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control <?php $__errorArgs = ['bed_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="bed_type" placeholder="VD: King, Twin, Double" value="<?php echo e(old('bed_type')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="location" placeholder="VD: Tầng 2, Khu A" value="<?php echo e(old('location')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="image" accept="image/jpeg,image/png,image/jpg">
...
unset($__errorArgs, $__bag); ?>" name="description" rows="4" placeholder="Nhập mô tả chi tiết về phòng nghỉ"><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('admin.layouts.admin_master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Php\htdocs\CODEPHP\resources\views/admin/rooms/create.blade.php ENDPATH**/ ?>