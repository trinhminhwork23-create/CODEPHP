      ...
      <div class="row">
        <div class="col-12">
          <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
            ...
            <div>
              <a href="<?php echo e(url('/admin/rooms')); ?>" class="btn btn-primary">Go to Inventory List</a>
            </div>
          </div>
        </div>
      </div>
...
<?php echo $__env->make('admin.layouts.admin_master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\CODEPHP\resources\views/admin/rooms/create.blade.php ENDPATH**/ ?>