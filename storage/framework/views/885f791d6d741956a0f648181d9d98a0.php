              ...
              <tbody>
                ...
                <tr class="align-middle">
                  ...
                  <td>
                    ...
                    <form action="<?php echo e(route('admin.categories.destroy', $category->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Bạn có chắc chắn muốn xóa loại phòng <?php echo e($category->name); ?>?')">
                      <?php echo csrf_field(); ?>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <form action="<?php echo e(route('admin.categories.update', $category->id)); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="_edit_id" value="<?php echo e($category->id); ?>">
...
unset($__errorArgs, $__bag); ?>" name="image" accept="image/jpeg,image/png,image/jpg" required>
...
<script>
    ...
    <?php if($errors->any() && !old('_edit_id')): ?>
    ...
    <?php if($errors->any() && old('_edit_id')): ?>
        var editModal = new bootstrap.Modal(document.getElementById('editCategoryModal<?php echo e(old('_edit_id')); ?>'));
        editModal.show();
    <?php endif; ?>
</script>
<?php $__env->stopPush(); ?>
