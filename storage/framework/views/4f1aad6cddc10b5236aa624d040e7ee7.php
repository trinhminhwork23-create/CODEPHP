                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-text">
                        ...
                        <div class="bt-option">
                            ...
                            <a href="<?php echo e(route('profile.history')); ?>">Lịch sử đặt phòng</a>
                            <span>Chi tiết</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <div class="booking-detail-card">
                        ...
                        <div class="detail-row">
                            ...
                            <span class="detail-value">SJD-<?php echo e(str_pad($booking->id, 6, '0', STR_PAD_LEFT)); ?></span>
                        </div>
                        ...
                        <div class="detail-row">
                            ...
                            <span class="detail-value"><?php echo e($booking->room->name ?? 'N/A'); ?></span>
                        </div>

                        <div class="detail-row">
                            <span class="detail-label">Loại phòng:</span>
                            <span class="detail-value"><?php echo e($booking->room->category->name ?? 'N/A'); ?></span>
                        </div>

                        <div class="detail-row">
                            <span class="detail-label">Ngày nhận phòng:</span>
                            <span class="detail-value"><?php echo e(\Carbon\Carbon::parse($booking->check_in)->format('d/m/Y')); ?></span>
                        </div>

                        <div class="detail-row">
                            <span class="detail-label">Ngày trả phòng:</span>
                            <span class="detail-value"><?php echo e(\Carbon\Carbon::parse($booking->check_out)->format('d/m/Y')); ?></span>
                        </div>

                        <div class="detail-row">
                            <span class="detail-label">Số đêm:</span>
                            <span class="detail-value">
                                <?php echo e(max(1, \Carbon\Carbon::parse($booking->check_in)->diffInDays(\Carbon\Carbon::parse($booking->check_out)))); ?> đêm
                            </span>
                        </div>

                        <div class="detail-row">
                            <span class="detail-label">Số người lớn:</span>
                            <span class="detail-value"><?php echo e($booking->adults ?? 1); ?> người</span>
                        </div>

                        <div class="detail-row">
                            <span class="detail-label">Số trẻ em:</span>
                            <span class="detail-value"><?php echo e($booking->children ?? 0); ?> trẻ</span>
                        </div>

                        <div class="detail-row">
                            <span class="detail-label">Tổng tiền:</span>
                            <span class="detail-value price"><?php echo e(number_format($booking->total_money, 0, ',', '.')); ?>₫</span>
                        </div>

                        <div class="detail-row">
                            <span class="detail-label">Ngày đặt:</span>
                            <span class="detail-value"><?php echo e($booking->created_at->format('d/m/Y H:i')); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="booking-detail-card">
                        ...
                        <?php if($booking->status == \App\Models\Booking::STATUS_PENDING): ?>
                            ...
                            <div id="payment-buttons" style="display: flex; flex-direction: column; gap: 12px; align-items: center; max-width: 400px; margin: 0 auto;">
                                ...
                                <form action="<?php echo e(route('bookings.cancel', $booking->id)); ?>" method="POST" style="margin: 0; width: 100%;" onsubmit="return confirm('Bạn có chắc muốn hủy đơn đặt phòng này?')">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" 
                            ...
                            <?php if(app()->environment(['local', 'development']) || config('app.debug')): ?>
                                <div style="border-top: 2px dashed #ddd; margin-top: 30px; padding-top: 20px;">
                                    ...
                                    <form action="<?php echo e(route('bookings.simulateTimeout', $booking->id)); ?>" method="POST" style="margin: 0;" onsubmit="return confirm('⚠️ Bạn có chắc muốn kích hoạt mô phỏng hết hạn? Đơn sẽ chuyển sang trạng thái \'Hủy\' ngay lập tức.')">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit" 
                        ...
                        <?php elseif($booking->status == \App\Models\Booking::STATUS_DEPOSIT_PAID): ?>
                            ...
                            <div style="display: flex; flex-direction: column; gap: 12px; align-items: center; max-width: 400px; margin: 0 auto;">
                                ...
                                <form action="<?php echo e(route('bookings.cancel', $booking->id)); ?>" method="POST" style="margin: 0; width: 100%;" onsubmit="return confirm('Bạn có chắc muốn hủy đơn đặt phòng này? Tiền cọc có thể không được hoàn trả.')">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" 
                                            style="width: 100%; padding: 14px 35px; font-size: 15px; font-weight: 700; text-align: center; background-color: #dc3545; border: none; border-radius: 3px; color: #ffffff; cursor: pointer; transition: opacity 0.3s;" 
                                            onmouseover="this.style.opacity='0.85'" 
                        ...
                        <div class="text-center mt-4">
                            <a href="<?php echo e(route('profile.history')); ?>" class="btn btn-outline-secondary" style="padding: 12px 30px; font-size: 14px; border-radius: 2px; border-color: #6c757d; color: #6c757d;">
    ...
    <?php if($booking->status == \App\Models\Booking::STATUS_PENDING): ?>
        <script>
            (function() {
                ...
                const bookingCreatedAt = new Date('<?php echo e($booking->created_at->toIso8601String()); ?>');
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\CODEPHP\resources\views/bookings/show.blade.php ENDPATH**/ ?>