    ...
    <section class="rooms-section spad">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="room-item">
                        <img src="{{ asset('img/room/room-4.jpg') }}" alt="">
                        <div class="ri-text">
                            <h4>Phòng Luxury</h4>
                            <h3>159$<span>/Đêm</span></h3>
                            <table>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="room-item">
                        <img src="{{ asset('img/room/room-5.jpg') }}" alt="">
                        <div class="ri-text">
                            ...
                            <a href="{{ route('rooms.show', 5) }}" class="primary-btn">Xem chi tiết</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="room-item">
                        <img src="{{ asset('img/room/room-6.jpg') }}" alt="">
                        <div class="ri-text">
                            ...
                            <a href="{{ route('rooms.show', 6) }}" class="primary-btn">Xem chi tiết</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12">
