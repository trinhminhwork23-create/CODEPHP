                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-item set-bg" data-setbg="{{ asset('img/blog/blog-4.jpg') }}">
                            <div class="bi-text">
                                <span class="b-tag">Tin tức địa phương</span>
                                <h4><a href="{{ route('blog.show', 4) }}">Hướng dẫn ngắm sao đêm trọn vẹn nhất</a></h4>
                                <div class="b-time"><i class="icon_clock_alt"></i> 22 Tháng Tư, 2019</div>
                            </div>
                        </div>
                </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-item set-bg" data-setbg="{{ asset('img/blog/blog-5.jpg') }}">
                            <div class="bi-text">
                                <span class="b-tag">Cắm trại dã ngoại</span>
                                <h4><a href="{{ route('blog.show', 5) }}">Kinh nghiệm du lịch bụi hữu ích</a></h4>
                                <div class="b-time"><i class="icon_clock_alt"></i> 25 Tháng Tư, 2019</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-item set-bg" data-setbg="{{ asset('img/blog/blog-6.jpg') }}">
                            <div class="bi-text">
                                <span class="b-tag">Hành trình du lịch</span>
                                <h4><a href="{{ route('blog.show', 6) }}">Nơi cắm trại lý tưởng nhất Virginia</a></h4>
                                <div class="b-time"><i class="icon_clock_alt"></i> 29 Tháng Tư, 2019</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-item set-bg" data-setbg="{{ asset('img/blog/blog-7.jpg') }}">
                            <div class="bi-text">
                                <span class="b-tag">Sự kiện</span>
                                <h4><a href="{{ route('blog.show', 7) }}">Kinh nghiệm cắm trại tiết kiệm cho người mới</a></h4>
                                <div class="b-time"><i class="icon_clock_alt"></i> 05 Tháng Năm, 2019</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-item set-bg" data-setbg="{{ asset('img/blog/blog-8.jpg') }}">
                            <div class="bi-text">
                                <span class="b-tag">Sự kiện</span>
                                <h4><a href="{{ route('blog.show', 8) }}">Du ngoạn Costa Rica hoang sơ và kỳ bí</a></h4>
                                <div class="b-time"><i class="icon_clock_alt"></i> 08 Tháng Năm, 2019</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-item set-bg" data-setbg="{{ asset('img/blog/blog-9.jpg') }}">
                            <div class="bi-text">
                                <span class="b-tag">Hành trình du lịch</span>
                                <h4><a href="{{ route('blog.show', 9) }}">Những mẹo du lịch an toàn khi đi xa</a></h4>
                                <div class="b-time"><i class="icon_clock_alt"></i> 12 Tháng Năm, 2019</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
